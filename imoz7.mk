...
#MY_MAKE := $(KERNEL_SRC)/../mymake TARGET_PRODUCT=imoz7 MTK_ROOT_CUSTOM=$(ANDROID_BUILD_TOP)/$(KERNEL_SRC)/../mediatek/custom KBUILD_OUTPUT_SUPPORT=yes -j8
MY_MAKE := $(MAKE) TARGET_PRODUCT=imoz7 MTK_ROOT_CUSTOM=$(ANDROID_BUILD_TOP)/$(KERNEL_SRC)/../mediatek/custom KBUILD_OUTPUT_SUPPORT=yes
